...
function Header()
{
    ...
    $this->Cell(80);
    // Título
    $this->Cell(30,10,'Reporte de ventas Usuarios',0,0,'C');//
    // Salto de línea
    $this->Ln(20);

    $this->Cell(25,10,"Id Compra",1,0,'C',0);
    $this->Cell(25,10,"ID Cliente",1,0,'C',0);
...
while($row=$resultado->fetch_assoc())
{
    ...
    $pdf->Cell(25,10,$row["idCli"],1,0,'C',0);
    $pdf->Cell(70,10,$row["nombre"],1,0,'C',0);
    $pdf->Cell(70,10,$row["email"],1,1,'C',0);
    //$pdf->Cell(40,10,$row["direccion"],1,1,'C',0);
