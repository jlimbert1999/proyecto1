        ...
        response.forEach(element =>{
            ...
            $("#tablaPasarela tbody").append(
                ...
                <tr>
                    ...
                    <input type="hidden" name="precio[]" value=" bs.${precio.toFixed(2)}">
...
$(document).on("click",".borrarProducto",function(e){
    ...
    function llenarCarrito(response){
        ...
        response.forEach(element => {
                $("#listaCarrito").append(
                `
                <a href="indexx.php?modulo=detalleproducto&id=${element['id']}" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
        ...
        $("#listaCarrito").append(
            `<a href="indexx.php?modulo=carrito" class="dropdown-item dropdown-footer text-primary">
            ver carrito
